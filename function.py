...
3. code are readable when we use functions.
4. function return the value.
...
1. a funtion name shouls tsart with alphabets or underscore(_)
2. we can use only alphabets, number and underscore(_) in a function name.
3. we cannot give space while naming function.
'''
